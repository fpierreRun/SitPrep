...
;}
 ...
 var calculate = function () {
    ...
    months = document.getElementById("months").value*30;
    ...
    var leaveningNeeded =  (((~~adults*.14) + (~~kids*.14)) * ((~~days) + (~~weeks) + (~~months) + (~~years))).toFixed(2);
    var leaveningRec = (leaveningNeeded - (~~leavening)).toFixed(2)
    var leaveningProgress = ((leavening/leaveningNeeded)*100).toFixed(2) 

    // //equation for salt
    var saltNeeded =  (((~~adults*.14) + (~~kids*.14)) * ((~~days) + (~~weeks) + (~~months) + (~~years))).toFixed(2);
    var saltRec = (saltNeeded - (~~salt)).toFixed(2)
    var saltProgress = ((salt/saltNeeded)*100).toFixed(2) 

    // //equation for fats
    var fatsneeded =  (((~~adults*.14) + (~~kids*.14)) * ((~~days) + (~~weeks) + (~~months) + (~~years))).toFixed(2);
