...
app.get('/', (req, res) => {
  res.sendFile(__dirname + '/qadraft1.html');
});
...
app.post('/ask', async (req, res) => {
  ...
  try {
    ...
    const apiKey = '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';
   ...
   if (
    ...
    if (!model) {
      const customResponse = "I'm sorry, but I cannot answer that question. Please ask a question related to emergency preparedness or ingredients.";
